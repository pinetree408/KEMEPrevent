...
public class KEMEPrevent implements NativeKeyListener {
  ...
  public void nativeKeyPressed(NativeKeyEvent e) {
    ...
    meLogger.log(e, topProcess.getNowLanguage(), topProcess.getNowTopProcess(), "null", prevent.getPreventState());
  }
  ...
  public static void main(String[] args) {
    ...
    GlobalScreen.addNativeKeyListener(new KEMEPrevent());
